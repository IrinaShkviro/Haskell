...
simple (Sum (Const 0) arg2) = simple arg2
simple (Sum arg1 (Const 0)) = simple arg1
simple (Divis arg1 (Const 1)) = simple arg1
simple (Divis (Const 0) _) = Const 0
simple (Mul (Const 1) arg2) = simple arg2
simple (Mul arg1 (Const 1)) = simple arg1
simple (Mul (Const 0) _) = Const 0
simple (Mul _ (Const 0)) = Const 0
simple (Sub arg1 (Const 0)) = simple arg1
simple (Degree arg1 arg2) = Degree (simple arg1) arg2
...
p' (Degree var deg) = simple (Mul (Mul (Const deg) (Degree var (deg - 1))) (myP var))
p' (Sum ad1 ad2) = simple (Sum (myP ad1) (myP ad2))
p' (Divis arg1 arg2) = simple (Divis (Sub (Mul (myP arg1) arg2) (Mul (myP arg2) arg1)) (Mul arg2 arg2))
p' (Mul arg1 arg2) = simple (Sum (Mul (myP arg1) arg2) (Mul arg1 (myP arg2)))
p' (Sub arg1 arg2) = simple (Sub (myP arg1) (myP arg2))
p' (Var) = Const 1
p' (Const a) = Const 0
